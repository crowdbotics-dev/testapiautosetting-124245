...
## Project Structure
    ...
    ├── testapiautosetting_124245  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124245`
...
2. Clone this repo and `cd testapiautosetting_124245`
